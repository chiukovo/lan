<?php
/*
Plugin Name: WP User Frontend 用户前端基础版(使用专业版必须安装)
Plugin URI:米粒小屋博客 https://www.m213.cn
Description: 在 WordPress站点 前端创建, 编辑, 删除, 管理你的文章, 页面. 前端注册表单和个人资料编辑...
Author: 米粒小屋博客
Version: 4.0.1
Author URI: https://www.m213.cn
*/

define( 'WPUF_VERSION', '4.0.1' );
...
final class WP_User_Frontend {
    ...
    function load_textdomain() {
        load_plugin_textdomain( 'wpuf', false, dirname( plugin_basename( __FILE__ ) ) . '/languages-DaiYunXuan-finished/' );
    }
    ...
    function plugin_action_links( $links ) {
        ...
        if ( ! $this->is_pro() ) {
            $links[] = '<a href="' . WPUF_Pro_Prompt::get_pro_url() . '" target="_blank" style="color: red;">专业版</a>';
        }

        $links[] = '<a href="' . admin_url( 'admin.php?page=wpuf-settings' ) . '">设置</a>';
        $links[] = '<a href="http://www.m213.cn" target="_blank">教程</a>';
