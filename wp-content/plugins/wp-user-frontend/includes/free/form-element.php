    ...
    public static function render_registration_settings() {
        ...
        <tr class="wpuf-post-type">
            ...
            <td>
                ...
                <input disabled type="checkbox" id="wpuf-enable_email_verification" name="" value="yes" <?php checked( $email_verification, 'yes' ); ?> > <label for="wpuf-enable_email_verification">启用电子邮件验证</label>
            </td>
        </tr>
