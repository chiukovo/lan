...
class WPUF_Admin_Profile_Form_Pro {
            ...
            <table class="form-table">
                <tr class="wpuf-post-type">
                    ...
                    <td>
                        ...
                        <input type="checkbox" id="wpuf-enable_email_verification" name="wpuf_settings[enable_email_verification]" value="yes" <?php checked( $email_verification, 'yes' ); ?> > <label for="wpuf-enable_email_verification">启用电子邮件验证</label>
                    </td>
                </tr>
    ...
    public function add_profile_field_section() {
        $profile_fields = apply_filters( 'wpuf-form-builder-wp_profile-fields-section-post-fields', array(
            'user_login', 'first_name', 'last_name', 'nickname', 'user_email', 'user_url', 'user_bio', 'password', 'avatar'
        ) );
